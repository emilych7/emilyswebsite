...
export default function Welcome() {
    ...
    return (
        <div className="flex flex-col md:flex-row size-full p-5 items-center justify-center text-white space-x-5 space-y-4">
            <div className="text-center h-full max-w-lg pt-12 justify-center items-center flex flex-col space-y-1">
                <h1 className="text-center pt-5 text-md font-semi-bold">Hi, I am </h1>
            ...
            <div className="bg-center items-center flex justify-center"> 
                <Image 
