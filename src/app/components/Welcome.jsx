...
export default function Welcome() {
    ...
    return (
            ...
            <div className="max-w-xl flex flex-col items-center text-center justify-center pt-10 px-10 lg:p-10 ">
                ...
                <p className="text-md pb-5">and welcome to my digital diary. I enjoy building and improving user interfaces, leading with the user experience in mind, and learning something new every day.</p>
                </div>
