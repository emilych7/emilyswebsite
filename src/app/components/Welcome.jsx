    ...
    return (
        <div className="flex size-full p-5 items-center justify-center text-white">
            ...
            <div className="text-center h-full max-w-lg justify-center items-center flex flex-col space-y-1">
                ...
                <p className="text-center text-md pb-3">and welcome to my digital diary. I enjoy building and improving user interfaces, leading with the user experience in mind, and learning something new every day.</p>
